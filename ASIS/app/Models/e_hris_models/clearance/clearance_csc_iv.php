...
class clearance_csc_iv extends Model
{
    use HasFactory;
    protected $connection = 'e-hris';
    protected $table = 'clearance_csc_iv';
    protected $primaryKey = 'id';

    protected $fillable = [

        'id', 'clearance_id', 'type', 'unit_office_dept_name', 'cleared', 'not_cleared', 'clearing_officer', 'signature', 'active',
