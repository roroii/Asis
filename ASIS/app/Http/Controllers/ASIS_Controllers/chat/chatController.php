...
namespace App\Http\Controllers\ASIS_Controllers\chat;
...
use App\Models\ASIS_Models\chat\chat_conversation;
use App\Models\ASIS_Models\chat\chat_members;
use App\Models\ASIS_Models\chat\chat_messages;
use App\Models\ASIS_Models\chat\chat_viewers;
...
class chatController extends Controller
{
     ...
     */
     ...
     public function load_all_contacts(Request $request){
        ...
        $load_all_contacts = '';
        $profile = employee::with('getUsername')->whereNotNull('firstname')->whereNotNull('lastname')->where('active',1)->whereHas('getUsername')->where('id','!=',Auth::user()->id)->get();
