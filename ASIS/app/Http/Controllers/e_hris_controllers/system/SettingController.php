...
class SettingController extends Controller
{
        ...
        public function add_setting(Request $request)
        {
            ...
            $user = Auth::user();
            $setting = new default_settingNew();
            ...
            $ss_id =  default_settingNew::updateOrCreate(['id' => $request->modal_set_update_id],$add_update_ss)->id;
    ...
    public function remove_ss(Request $request){
        ...
        if($request->has('ss_id')){
            ...
            default_settingNew::where(['id' =>  $request->ss_id])->first()->update($update_remove);
    ...
    public function load_details(Request $request){
        ...
        if($request->has('ss_id')){
            ...
            $get_ss = default_settingNew::where('active',1)
