...
class EnrollmentListExport implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents, WithBackgroundColor, WithStyles, WithDefaultStyles, WithColumnWidths
{
    /**
    ...
    {
        return ["Student ID", "Full Name", "Full Name", "Year Level", "Contact Number"];
    }
