                        ...
                        @forelse($assign_postions as $index => $assign_postion)
                            ...
                            @php
                                ...
                                if($assign_postion->getElect_position){
                                    ...
                                    $position_name = 'Data no longer exist in Position';
                                }
                            @endphp
                                            ...
                                            @forelse ($participants as $index => $participant)
                                                @php
                                                    ...
                                                    if($participant->get_student_applicants){
                                                        $participants_name = $participant->get_student_applicants->fullname;
                                                    }
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="width: 150px; text-align:center">{{  $vote_count }}</td>
                                                </tr>
