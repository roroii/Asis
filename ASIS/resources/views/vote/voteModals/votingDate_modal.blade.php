<!-- BEGIN: Modal Content -->
<div id="votingDate_Modal" class="modal" tabindex="-1" aria-hidden="true" data-tw-backdrop="static">
   <div class="modal-dialog modal-nd">
       <div class="modal-content"><a data-tw-dismiss="modal" href="javascript:;"><i class="fa-sharp fa-light fa-circle-xmark w-8 h-8 text-slate-400 zoom-in"></i> </a>
           ...
           <form id="votingDate_form" enctype="multipart/form-data">
           ...
           <div class="modal-footer">
               ...
               <button type="submit" href="javascript:;" class="btn btn-primary w-20 mr-1">Set</button>
           </div>
           <!-- END: Modal Footer -->
