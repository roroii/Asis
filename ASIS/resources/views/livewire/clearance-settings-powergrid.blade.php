<div>
    ...
    <div class="overflow-x-auto">
        <table id="clearance_signartories_tbl" class="table table-report -mt-2">
            <thead>
            <tr>
            ...
            @foreach ($signatories as $signatory)
                ...
                <tr class="intro-x zoom-in px-2">
                    <td class="w-40 !py-4"> <a href="javascript:;" class="underline decoration-dotted whitespace-nowrap">{{ $signatory['signatory_id'] }}</a> </td>
                    <td class="w-40">
                        <a href="javascript:;" class="font-medium whitespace-nowrap">{{ $signatory['full_name'] }}</a>
                    </td>
                    ...
                    <td class="text-center">
                        <div class="flex whitespace-nowrap"
                             ...
                             wire:key="{{ $signatory['signatory_id'] }}"
                        >
                            ...
                            <a href="javascript:;" class="font-medium whitespace-nowrap">
                                <span x-show="!editing" class="text-slate-500 text-xs whitespace-nowrap mt-0.5">{{ $signatory['designation'] }}</span>
                                <input x-ref="input"
                                       x-show="editing"
                                       type="text"
                                       placeholder="Add Designation"
                                       x-model="newDesignation"
                                       @keydown.enter="() => { $wire.updateDesignation('{{ $signatory['signatory_id'] }}', newDesignation); editing = false; $refs.input.blur(); }"
                    ...
                    <td class="table-report__action w-56">
                        <div class="flex justify-center items-center">
                            ...
                            <a class="flex items-center text-danger" href="javascript:;" wire:click.prevent="deleteSignatory('{{ $signatory['signatory_id'] }}')">
