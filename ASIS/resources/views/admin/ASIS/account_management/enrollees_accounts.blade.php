...
@section('breadcrumb')
    {{ Breadcrumbs::render('Enrollees Accounts') }}
@endsection
...
@section('content')
    ...
    <div class="intro-y col-span-12 overflow-auto lg:overflow-visible mt-5">
        <table class="table table-report -mt-2" id="enrollees-list-table">
            <thead>
            <tr>
                <th class="whitespace-nowrap">ENROLLEES ID</th>
...
@section('scripts')
    ...
    <script src="{{BASEPATH()}}/js/ASIS_js/Accounts/manage_enrollees_account.js{{GET_RES_TIMESTAMP()}}"></script>
