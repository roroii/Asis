...
<div id="hold_modal_add_attachments" data-tw-backdrop="static" class="modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body ">
                ...
                <div id="hold_if_no_files_attached" class="col-span-12 sm:col-span-6 "></div>

                {{--        For Original Attachments        --}}
                <div id="div_dt_hold_original_attachments" >
                    ...
                    <div class="overflow-x-auto scrollbar-hidden pb-5">
                        <table id="dt_hold_original_attachments" class="table table-report -mt-2 table-hover">
                ...
                <div id="div_dt_hold_added_attachments" >
                    <div style="border-radius: 0.375rem;" class="alert-dark text-center show p-3">Added Attachment(s)</div>
                    <div class="overflow-x-auto scrollbar-hidden pb-5">
                        <table id="dt_hold_added_attachments" class="table table-report -mt-2 table-hover">
                ...
                <div id="hold_add_attachments_div" class="grid grid-cols-2"></div>
                <!-- END: Modal Content -->
