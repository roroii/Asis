 <!-- BEGIN: Modal Content -->
 <div id="hiring_modal" class="modal" tabindex="-1" aria-hidden="true" data-tw-backdrop="static">
    <div class="modal-dialog modal-lg">
        ...
        <form id="hiring_form">
            ...
            <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                ...
                <div class="col-span-12 sm:col-span-12"> <label for="modal-form-1" class="form-label font-medium">Panels</label>
                    <div >
                        <select id="panel" class="select2-multiple w-full" multiple="multiple">
