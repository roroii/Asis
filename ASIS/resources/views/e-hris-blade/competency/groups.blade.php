...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <button class="btn btn-primary shadow-md mr-2 b_action" data-type="action" data-target="show-add">Add New Group</button>
        </div>
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h2 id="" class="font-bold text-base mr-auto">Add Group</h2>
...
@section('scripts')
    <script src="{{BASEPATH()}}/js/competency/groups.js{{GET_RES_TIMESTAMP()}}"></script>
@endsection()
