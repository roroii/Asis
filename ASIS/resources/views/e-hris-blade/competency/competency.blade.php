...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <button class="btn btn-primary shadow-md mr-2">Add New Award</button>
            <div class="dropdown">
        ...
        <div class="intro-y col-span-12 overflow-x-auto scrollbar-hidden overflow-auto lg:overflow-visible">
                <table id="dt_rewards" class="table table-report -mt-2 table-hover">
                    <thead>
                    <tr>
...
@section('scripts')
    <script src="{{BASEPATH()}}/js/rr/rewards.js"></script>
@endsection()
