                        ...
                        <div class="col-span-12 sm:col-span-6 xl:col-span-4 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-base text-slate-500 mt-1 fs_c_4">Daily Time Record Printed <br/>(Total)</div>
                                </div>
                            </div>
                        </div>
                        <div class="col-span-12 sm:col-span-6 xl:col-span-4 intro-y">
                            <div class="report-box zoom-in">
                                <div class="box p-5">
                                    ...
                                    <div class="text-base text-slate-500 mt-1 fs_c_4">Daily Time Record Printed <br/>(Current Date Range)</div>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('scripts')
    <script src="{{BASEPATH()}}/js/dtr/dtr_overview.js{{GET_RES_TIMESTAMP()}}"></script>
@endsection()
