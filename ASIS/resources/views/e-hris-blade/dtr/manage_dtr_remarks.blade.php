...
@section('content')
    ...
    <!-- BEGIN: Modal Content -->
    <div id="mdl__remarks_edit" class="modal" tabindex="-1" aria-hidden="true" data-tw-backdrop="static">
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <!-- BEGIN: Modal Header -->
                <div class="modal-header">
                    <h2 id="" class="font-bold text-base mr-auto">Edit Remarks</h2>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" href="javascript:;" class="btn btn-primary w-20 b_action" data-type="action" data-target="remarks-save">Save</button>
                </div>
                <!-- END: Modal Footer -->
...
@section('scripts')
    <script src="{{BASEPATH()}}/js/dtr/manage_dtr_remarks.js{{GET_RES_TIMESTAMP()}}"></script>
@endsection()
