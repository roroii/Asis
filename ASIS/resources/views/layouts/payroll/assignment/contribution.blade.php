...
{{--            <button class="btn btn-primary shadow-md mr-2">Add New Contribution</button>--}}
        ...
        <div class="intro-y col-span-12 overflow-auto overflow-x-auto scrollbar-hidden lg:overflow-visible">
                <table id="dt_contribution_emp" class="table table-report -mt-2 table-hover">
                    <thead>
                    <tr>
                        <th class="hidden">ID</th>
                        <th class="whitespace-nowrap">NAME</th>
                        <th class="whitespace-nowrap">CONTRIBUTIONS</th>
...
@section('scripts')
    <script src="../js/payroll/contribution.js"></script>
@endsection()
