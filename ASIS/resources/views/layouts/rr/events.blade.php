                ...
                <div class="modal-body px-5 py-10">
                    <div>
                        ...
                        <div class="mb-5">
                            ...
                            <input type="date" id="s_date" name="s_date" min="0" class="form-control" placeholder="">
                        </div>
                        
                        <div class="mb-5">
                            <label for="e_date"> End Date</label>
                            <input type="date" id="e_date" name="e_date" min="0" class="form-control" placeholder="">
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body px-5 py-10">
                    <div>
                        ...
                        <div class="mb-5">
                            <label for="s_date"> Start Date</label>
                            <input type="date" id="upd_s_date" name="s_date" class="form-control" placeholder="">
                        </div>
                        
                        <div class="mb-5">
                            <label for="e_date"> End Date</label>
                            <input type="date" id="upd_e_date" name="e_date" class="form-control" placeholder="">
                        </div>
...
@section('scripts')
    <script src="{{BASEPATH()}}/js/rr/events.js{{GET_RES_TIMESTAMP()}}"></script>
@endsection()
