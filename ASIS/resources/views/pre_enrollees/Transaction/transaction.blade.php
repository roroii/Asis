...
<!--
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap xl:flex-nowrap items-center">
            ...
            <div id="approve_appointment_div" class="flex w-full sm:w-auto">

                <a id="btn_approved_appointments" class="flex items-center text-primary mr-2 btn btn-outline-primary" href="javascript:;">
                    <i data-lucide="thumbs-up" class="w-4 h-4 text-primary mx-auto fa-beat mr-1"></i>
                    Approve
                </a>
                <a id="btn_disapproved_appointments" class="flex items-center text-danger mr-auto btn btn-outline-danger" href="javascript:;">
                    <i data-lucide="thumbs-down" class="w-4 h-4 text-danger mx-auto mr-1"></i>
                    Disapprove
                </a>
            </div>
...
-->
    ...
    <div class="intro-y col-span-12 overflow-auto lg:overflow-visible mt-2">

        <table class="table table-report -mt-2" id="transaction-list-table">
            <thead>
            <tr>
<!--                <th class="whitespace-nowrap">
                    <input id="checkAll_transactions" class="form-check-input" type="checkbox">
                </th>-->
...
@section('scripts')
    ...
    <script src="{{BASEPATH()}}/js/ASIS_js/Transactions/admin_transactions.js{{GET_RES_TIMESTAMP()}}"></script>
