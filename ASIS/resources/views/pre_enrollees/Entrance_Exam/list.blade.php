...
@section('breadcrumb')
    {{ Breadcrumbs::render('Examinees List') }}
@endsection
    ...
    <div class="intro-y col-span-12 overflow-auto lg:overflow-visible mt-5">
        <table class="table table-report -mt-2" id="transaction-list-table">
            ...
            <tr>
                ...
                <th class="text-center whitespace-nowrap">EXAMINATION STATUS</th>
                <th class="whitespace-nowrap">APPOINTMENT DETAILS</th>
...
@section('scripts')
    ...
    <script src="{{BASEPATH()}}/js/ASIS_js/Entrance_Exam/examinees_list.js{{GET_RES_TIMESTAMP()}}"></script>
