...
function data_update() {
    ...
    try{
        ...
        $.ajax({
            url: bpath + 'rr/awards/data/update',
            type: "POST",
            data: {
                '_token': _token,
                'id': id.val(),
...
function data_delete() {
    ...
    try{
        ...
        $.ajax({
            url: bpath + 'rr/awards/data/delete',
            type: "POST",
            data: {
                '_token': _token,
                'id': id.val(),
                ...
                if(data.length > 0) {
                    for(var i=0;i<data.length;i++) {
                        try{
                            ...
                            $('#' + 'upd_' + 'type').val(data[i]['type']);
                            $('#' + 'upd_' + 'type').trigger('change');
                            /***/
                            try{
