...
$(function() {
    ...
    $('#pnotify-desktop-danger').on('click', function () {
        ...
        (new PNotify({
            ...
            type: 'danger',
            text: 'I\'m a danger desktop adminNotification, if you have given me a permission.',
            desktop: {
                desktop: true,
            ...
            alert('Hey! You clicked the desktop adminNotification!');
        });
    });
    ...
    $('#pnotify-desktop-success').on('click', function () {
        ...
        (new PNotify({
            ...
            type: 'success',
            text: 'I\'m a success desktop adminNotification, if you have given me a permission.',
            desktop: {
                desktop: true,
    ...
    $('#pnotify-desktop-warning').on('click', function () {
        ...
        (new PNotify({
            ...
            type: 'warning',
            text: 'I\'m a warning desktop adminNotification, if you have given me a permission.',
            desktop: {
                desktop: true,
    ...
    $('#pnotify-desktop-info').on('click', function () {
        ...
        (new PNotify({
            ...
            type: 'info',
            text: 'I\'m an info desktop adminNotification, if you have given me a permission.',
            desktop: {
                desktop: true,
